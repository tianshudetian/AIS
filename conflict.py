...
df = pd.read_csv(r'/home/mty/data/dynamic/20181007.csv')
...
new_time = np.arange(Timestamps[0], Timestamps[-1]+1, 60)
Result = []
...
b.to_csv(r'/home/mty/conflictNUM20181007.csv')